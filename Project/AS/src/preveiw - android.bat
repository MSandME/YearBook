...
rem debugger V
rem %adl% "%name%-app.xml"
rem -profile mobileDevice -screensize %dAA3% 

rem android export V
%adt% -package -target apk-captive-runtime -storetype pkcs12 -storepass 183818381 -keystore "D:\MES Job 93-1-11\MESepehr.p12" "%name%.apk" "%name%-app.xml" %name%.swf %contents%
